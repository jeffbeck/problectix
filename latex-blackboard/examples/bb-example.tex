...
%  \end{bbminipage}
  ...
  \begin{bbminipage}{14}{4}
    Wie das mit Grafiken gemacht wird sieht man auf der nächsten
    Seite. Der Strich unten gibt die Umbruchsbreite dieser Minipage
    an. Er sollte mit dem danebenliegenden Strich fluchten\par
    \rule{\linewidth}{1mm}
  \end{bbminipage}
\end{bbwide}
%%%
