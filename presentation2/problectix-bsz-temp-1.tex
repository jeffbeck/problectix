  ...
  \begin{overprint}
    ...
    \begin{itemize}
      ...
      \item<3-> \texttt{lincvs} starten
        ...
        \item<7-> Modul dem Arbeitsbereich hinzufügen (\textit{Arbeitskopie})
        \end{itemize}
    \end{itemize}
    \onslide<8->
     \textbf{Fertig!}
...
\begin{frame}
  ...
  \begin{overprint}
    ...
    \begin{itemize}
      ...
      \item<3-> Datei Doppelklicken zum Öffnen mit \texttt{kile}
...
\begin{frame}
  ...
  \begin{overprint}
    ...
    \begin{itemize}
      ...
      \item<5-> \ldots Ende!
      \item<6-> Mit \texttt{firefox} die Aufgabendatenbank ansehen:
  ...
  \begin{overprint}
    ...
    \begin{itemize}
      \item<2-> 2 Programme starten:
        \begin{itemize}
        \item<2-> Aufgaben mit \texttt{firefox} ansehen.
        \item<2-> Editor \texttt{kile} starten.\par
                  Datei \texttt{ka-vorlage.tex} öffnen. \par
                  \texttt{ka-vorlage.tex} anderem Dateinamen speichern.
        \end{itemize}
      \item<3-> Einfügebefehl der gewünschten Aufgabe in
        \texttt{firefox} auswählen (linke Maustaste).
      \item<4-> Markierter Befehl mit Mittlerer Maustaste in \texttt{kile} einfügen.
...
\begin{frame}
  \vfill
  Diese Präsentation wurde mit  \LaTeX{} erstellt.  
\end{frame}
