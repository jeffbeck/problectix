...
\put(\value{notenboxort},-\value{textfeldhoehe}){\makebox(\value{schritt},\value{textfeldhoehe}){\scriptsize
    \thepnpunkte}}
\put(\value{notenboxort},-\value{doppeltextfeldhoehe}){\makebox(\value{schritt},\value{textfeldhoehe}){\scriptsize
    y}}
\addtocounter{notenboxort}{-\value{schritt}}
