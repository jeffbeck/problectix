...
%% Text
  ...
  \scriptsize
  \put(31.2,1.8){\usebox{\usertoken}: \usebox{\fach}}
%  \put(0,-256.8){\makebox(176,4)[r]{{\usebox{\quelle}}}} %% Quellenangabe ermöglichen
  ...
  \put(56,0.54){\makebox(60,4)[r]{{\jobname.tex(\thepage)}}}
  %% großen Text (Fett) in Blattkopf zeichnen:
  \normalsize \bf
  \put(0,14){Berufliches}   \put(0,8.5){Schulzentrum}   \put(0,3){Leonberg}
  \put(73.5,13.8){\makebox(0,0)[b]{{\usebox{\titelo}}}}
  \put(73.5,8){\makebox(0,0)[b]{\usebox{\titelu}}}
%% Anderes Aussehen Lösung zeigen oder nicht
%%     \ifthenelse{\value{loesungein}=1}
%%        {%% Falls Lösungen gezeigt werden: 
%%           \put(122.3 ,6.1){\Huge  Lösung}}
%%        {%% Falls keine Lösungen gezeigt werden:
  %%\linethickness{0.25mm}%% Das ist die Linienbreite der schmalen Linien
  %%\put(117,12){\line(1,0){61}}   \put(165,0){\line(0,1){12}}
  %%\put(147,20){\line(0,-1){8}}
  %%\scriptsize \rm %% \rm gebraucht um von Fett zurückzuschalten
  %%\put(118.2,8.8){Name: }        \put(118.2,16.5){Datum: \usebox{\datum}}
  %%\put(166.2,8.8){Blatt:}        \put(148.2,16.5){Klasse: \usebox{\klasse}}
  %%\normalsize %% Eintragungen in Blattkopf zeichnen:
  %%\put(120.2,3){\usebox{\name}}  \put(168.2,3){\usebox{\blatt}}
%%        }
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Befehl, der den Arbeitsblatt-Kopf lädt
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Befehl, der die Namensbereich-Unterteilung lädtt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Senkrecht
\put(-2,20.25){\line(0,-1){277.5}}    \put(178,20.25){\line(0,-1){277.5}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Senkrecht
\put(-2,3.25){\line(0,-1){277.5}}    \put(178,3.25){\line(0,-1){277.5}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Befehl, der den Rahmen um das ganze Blattlädt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Text
  \normalsize \bf
  \put(0,14){Abschlussprüfung \usebox{\datumbf}}
  \put(97,3){Name: }
...
%% \newcommand{\pruefungspic}{
%% %% Breite Linien zeichnen:
%%   \linethickness{0.25mm}%% Das ist die Liniendicke der breiten Linien
%%   %% Waagrecht
%%   \put(110,13){\line(1,0){52}}            
%% %% Text
%%   \normalsize \bf
%%   \put(0,14){Abschlussprüfung \usebox{\datumbf}}
%%   \put(97,14){Name: }
%%   \put(0,8.5){Kälteanlagenbauer}
%% \ifthenelse{\value{projektbezug}=0}{
%% \put(0,3){Fachtheorie I (projektunabhängig)}
%% }{
%% \put(0,3){Fachtheorie II (projektbezogen)}
%% }   
%% }

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Befehl, der den Prüfungs-Kopf lädt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
